...
test('every painted art file maps to a glyph id the game actually uses', () => {
  ...
  known.add('p-0');
  for (const id of ['frame-bronze','frame-silver','frame-gold','frame-diamond','board-wood','bg-market','bg-intro','music-market','music-battle',
                    'g-coin','g-heart','g-gem','g-crown','g-door','g-lantern','g-phoenix','g-medallion','g-btn_stone']) known.add(id);

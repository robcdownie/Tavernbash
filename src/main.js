...
import {createFight,runHeadless,makeItem,fuseScan,genRival,playerFightItems,monsterSide,
        fightHP,stormAt,mulberry,integOf,usedCells,gateOK,boardRegen} from './engine.js';
...
if(typeof globalThis!=='undefined'){
  globalThis.BB={createFight:createFight,runHeadless:runHeadless,ITEMS:ITEMS,MONSTERS:MONSTERS,TRINKETS:TRINKETS,
   ...
   integOf:integOf,usedCells:usedCells,RSTAT:RSTAT,RINTEG:RINTEG,gateOK:gateOK,boardRegen:boardRegen,fxActive:fxActive,fxCount:fxCount};
}
